...
@Component({
  selector: 'app-personas-direccion-desarrollo',
  standalone: true,
  imports: [CommonModule, NgxPaginationModule],
  templateUrl: './personas-direccion-desarrollo.component.html',
  styleUrl: './personas-direccion-desarrollo.component.css'
})
export class PersonasDireccionDesarrolloComponent {
  ...
  realizarAccion() {
    this.showMessage = false;
    const url = 'https://ws-personas-direccion-mock-desarrollo.apps.interopera.jep.gov.co/personas/1/enderecos'; // Reemplaza con la URL de tu servicio REST
